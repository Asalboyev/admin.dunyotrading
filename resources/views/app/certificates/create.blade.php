...
{{--                                <div class="form-group">--}}
{{--                                    <!-- Dropzone -->--}}
{{--                                    <label  class="form-label text-capitalize">Сертификат</label>--}}
{{--                                    <input type="file" class="form-control " name="file" value="{{ old('title.'.$lang->code) }}" id="title" placeholder="File...">--}}
{{--                                </div>--}}
                                <div class="form-group">
                                    <!-- Dropzone -->
