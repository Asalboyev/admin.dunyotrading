                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="tab-content" id="myTabContent">
                                    ...
                                    <div class="tab-pane mt-3 fade {{ $loop->first ? 'show active' : '' }}" id="{{ $lang->code }}" role="tabpanel" aria-labelledby="{{ $lang->code }}-tab">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="desc[{{ $lang->code }}]" id="desc" cols="30" rows="10" class="form-control @error('desc.'.$lang->code) is-invalid @enderror ckeditor" name="desc[{{ $lang->code }}]" placeholder="Описание...">{{ old('desc.'.$lang->code) ?? $productsCategory->desc[$lang->code] ?? null }}</textarea>
                                ...
                                <div class="form-group">
                                            ...
                                            <input type="text"  class="form-control is-invalid " name="slug" value="{{ old('slug') ?? $productsCategory->slug ?? null }}" id="title" placeholder="slug...">
                                            @error('slug')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
